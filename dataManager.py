...
class plottool():
    ...
    def plotVolatilityMACD(self, data):        
        ...
        fig.update_layout(autosize=True, xaxis1_rangeslider_visible=False, xaxis2_rangeslider_visible=False, margin=dict(l=50,r=50,t=50,b=50), template='seaborn', title=f'test') 
...
if __name__ == '__main__':
    ...
    print(data_mg.event_cnt, total_rate, total_real_rate)
    ...
    for idx, event in event_data.iterrows():
        ...
        plot_tool.plotVolatilityMACD(data)
